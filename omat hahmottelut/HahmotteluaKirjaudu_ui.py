...
"color: rgb(0, 0, 0);")
        ...
        self.studentAndKyeLabel = QLabel(self.centralwidget)
        self.studentAndKyeLabel.setObjectName(u"studentAndKyeLabel")
        self.studentAndKyeLabel.setGeometry(QRect(530, 250, 271, 231))
        self.studentAndKyeLabel.setPixmap(QPixmap(u"studentAndKey.png"))
...
"alternate-background-color: rgb(2, 3, 109);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.studentAndKyeLabel.setText("")
