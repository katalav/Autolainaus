...
"background-color: rgb(51, 167, 181);")
        ...
        self.namesFrame.setGeometry(QRect(70, 180, 681, 481))
...
"background-color: rgb(0, 33, 72);")
        ...
        self.carsInfoStatusLabel.setGeometry(QRect(350, 310, 281, 71))
...
"color: rgb(0, 33, 72);")
        ...
        self.StudentsNameStatusLabel = QLabel(self.namesFrame)
        self.StudentsNameStatusLabel.setObjectName(u"StudentsNameStatusLabel")
        self.StudentsNameStatusLabel.setGeometry(QRect(40, 310, 281, 71))
...
"color: rgb(0, 33, 72);")
        ...
        self.timeLabel.setGeometry(QRect(340, 80, 121, 41))
        ...
        self.clockLabel.setGeometry(QRect(270, 80, 41, 41))
        ...
        self.returnDayLabel = QLabel(self.namesFrame)
        self.returnDayLabel.setObjectName(u"returnDayLabel")
        self.returnDayLabel.setGeometry(QRect(90, 20, 151, 71))
...
"background-color: rgb(65, 67, 158);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.returnDayLabel.setText(QCoreApplication.translate("MainWindow", u"Palautus p\u00e4iv\u00e4:", None))
