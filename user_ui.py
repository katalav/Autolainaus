...
"background-color: rgb(51, 167, 181);")
        ...
        self.namesFrame.setGeometry(QRect(50, 180, 681, 481))
...
"color: rgb(0, 33, 72);")
        ...
        self.returnDayLabel.setGeometry(QRect(30, 30, 151, 71))
...
"")
        ...
        self.startFrame.setGeometry(QRect(30, 170, 781, 631))
        ...
        self.carPhotoLabel = QLabel(self.startFrame)
        self.carPhotoLabel.setObjectName(u"carPhotoLabel")
        self.carPhotoLabel.setGeometry(QRect(250, 430, 251, 191))
        self.carPhotoLabel.setPixmap(QPixmap(u"uiPictures/XUX682.png"))
