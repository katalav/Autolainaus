...
"background-color: rgb(51, 167, 181);")
        ...
        self.studentAndKeyLabel.setGeometry(QRect(30, -20, 231, 241))
        self.namesFrame = QFrame(self.centralwidget)
        self.namesFrame.setObjectName(u"namesFrame")
        self.namesFrame.setGeometry(QRect(10, 190, 541, 171))
        ...
        self.lastNameLineEdit.setGeometry(QRect(280, 260, 181, 31))
...
"")
        ...
        self.firstNameLineEdit.setGeometry(QRect(40, 260, 181, 31))
