...
"background-color: rgb(51, 167, 181);")
        ...
        self.namesFrame.setGeometry(QRect(110, 330, 681, 381))
...
"color: rgb(7, 7, 7);")
        ...
        self.valmisPushButton.setGeometry(QRect(220, 270, 211, 61))
